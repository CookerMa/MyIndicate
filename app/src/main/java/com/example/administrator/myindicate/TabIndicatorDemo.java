 ...
 *
 */
public class TabIndicatorDemo extends LinearLayout
{
    /**
     * 绘制三角形的画笔
     */
    ...
    public TabIndicatorDemo(Context context)
    {
        this(context, null);
    }

    public TabIndicatorDemo(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    protected void dispatchDraw(Canvas canvas)
    {
        ...
        Rect rect = new Rect((int)mTranslationX , mTop, (int)mTranslationX + getScreenWidth()/mTabVisibleCount, mTop + mHeight);
